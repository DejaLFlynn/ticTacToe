...
class View {
    ...
    play(){
        ...
        if(this.game.gameOver()){
            ...
            this.displayBoard()
            this.bindEvents()
            playerText.innerText = this.game.currentPlayer.name + ' Its Your Turn, Click!!'
        }
    }
    displayBoard(){
...
document.addEventListener("DOMContentLoaded", ()=>{
    let game = new _Game_js__WEBPACK_IMPORTED_MODULE_0__["default"](
        new _HumanPlayer_js__WEBPACK_IMPORTED_MODULE_1___default.a('Deja', "O"),
        new _HumanPlayer_js__WEBPACK_IMPORTED_MODULE_1___default.a('Shawn', "X")
    )
